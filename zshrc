...
if [ -f ~/.zsh/zshalias ]; then
		...
		print "Note: ~/.zsh/zshalias is unavailable."
fi
...
#v#
export MAIL=${MAIL:-/home/illu/mail/inbox}
# Mails
...
if ls --help 2>/dev/null | grep -- --color= >/dev/null && [[ "$TERM" != dumb ]] ; then
    ...
    #alias ls='ls -b -CF --color=auto'
		alias ls='ls -loBh --color=auto --group-directories-first'
    ...
    alias ls='ls -b -CF --group-directories-first'
    alias la='ls -la'
    alias ll='ls -l'
    alias lh='ls -hAl'
    alias l='ls -lF'
...
if [[ -z "$BROWSER" ]] ; then
    if [[ -n "$DISPLAY" ]] ; then
        ...
        check_com -c w3m && export BROWSER=links2
    fi
fi
...
alias mpv='mplayer -cache 8000 -playlist $1'
# console stuff
...
GPG_TTY=$(tty)  
export GPG_TTY 
## dirty hack for keepass auto insert password function, otherwise wrong
## password (see here https://sourceforge.net/p/keepassx/bugs/269/ )
setxkbmap de
